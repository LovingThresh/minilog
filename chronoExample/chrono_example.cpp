...
int main() {
    ...
    // 设置会议时间
    const auto ny_time = zoned_time_type{"America/New_York",
        local_days{year{2023}/month{10}/day{5}} + 15h + 30min};
    ...
    const auto meeting_time = zoned_time_type {organizer_time_zone,
        local_days{year{2024}/month{3}/day{15}} + 14h + 30min};  // 设置会议时间为2024年3月15日14:30

    for (const std::vector<std::string> participant_time_zones =
